...
```{r}
resultados.hombres <- lapply(21:65, function(p) calcular_primas(p, qx.hombres))
...
resultados.mujeres <- lapply(21:65, function(l) calcular_primas(l, qx.mujeres))
...
```{r}
primas.hombres_metodo1 <- sapply((21:65), function(p) calcular_primas_metodo1(p, qx.hombres))
primas.mujeres_metodo1 <- sapply((21:65), function(l) calcular_primas_metodo1(l, qx.mujeres))
```
...
primas.hombres_metodo2 <- sapply((21:67), function(p) calcular_primas_metodo2(p, qx.hombres))
primas.mujeres_metodo2 <- sapply((21:67), function(l) calcular_primas_metodo2(l, qx.mujeres))
```
