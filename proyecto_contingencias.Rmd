...
#' @param n (Integert) Duración del seguro en años.
...
calcular_primas <- function(edad, tabla_mort) {
  ...
  ben_muerte_pens <-
    1000000 * Ax(65, (2024 + 65 - edad), tabla_mort, 115, tasa_j_eq) * ((1 / (1 + tasa_j_eq)) ^ (65 - edad)) * calcular_kpx(edad, (65 - edad), tabla_mort)
  
  # Pensión
  ben_anualidades <-
    13 * 300000 * (((1 - Ax(
      65, (2024 + 65 - edad), tabla_mort, 115, tasa_j_eq
    )) / (1 - (1 / (1 + tasa_j_eq)))) - 1) * ((1 / (1 + tasa_j_eq)) ^ (65 - edad)) * calcular_kpx(edad, (65 - edad), tabla_mort)
