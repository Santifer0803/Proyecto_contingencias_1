...
Luego, las proyecciones demográficas para empleados pensionados.
...
ggplot(df.primash, aes(x = c(21:65))) +
  geom_line(aes(y = primas_cuartil_50, color = "Cuartíl 50")) +
  geom_line(aes(y = primas_cuartil_90, color = "Cuartíl 90")) +
  labs(
    x = "Edades",
    y = "Cantidad de Prima",
    caption = "Fuente: elaboración propia"
...
ggplot(costos.combinados, aes(x = anno)) +
  geom_line(aes(y = costo, color = genero), linewidth = 1) +
  labs(x = "Año",
...
```{r tipos_primas_hombres, warning = FALSE}
...
# Crear el gráfico combinado
ggplot(primas.combinadas.h, aes(x = edad)) +
  geom_line(aes(y = primas, color = "Original")) +
  geom_line(aes(y = primas_metodo1, color = "Método 1")) +
  geom_line(aes(y = primas_metodo2.hombres, color = "Método 2")) +
  labs(x = "Edad",
       y = "Primas",
       caption = "Fuente: elaboración propia") +
  scale_color_manual(
...
```
Y un gráfico análogo para las mujeres.

```{r tipo_primas_mujeres, warning = FALSE}
# Extraemos las columnas que ocupamos de cada df
...
# Crear el gráfico combinado
ggplot(primas_combinadas, aes(x = edad)) +
  geom_line(aes(y = primas, color = "Original")) +
  geom_line(aes(y = primas_metodo1, color = "Método 1")) +
  geom_line(aes(y = primas_metodo2.mujeres, color = "Método 2")) +
  labs(x = "Edad",
       y = "Primas",
       caption = "Fuente: elaboración propia") +
  scale_color_manual(
    name = "Tipo de Primas",
    values = c("Original" = "salmon4", 
               "Método 1" = "blue", 
               "Método 2" = "green")) +
  theme_minimal()
